...
const AP_Scheduler::Task Copter::scheduler_tasks[] = {
    ...
    SCHED_TASK(rc_loop,               250,    130,  3), // MA: changed Hz from 250 to 50 since logger is not controlling anything
    ...
    SCHED_TASK(twentyfive_hz_logging, 25,    110, 117), // MA changed to 30 Hz
